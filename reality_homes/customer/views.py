...
def home(request):
    ...
    context = {'result':result,'result1':result1,'properties': result2}
...
def add_property(request):
    ...
    return render(request, 'customer/add_property.html', context)
...
def property_store(request):
    ...
    return redirect('/customer/add_property')
...
def view_my_property(request):
    ...
    return render(request, 'customer/view_my_property.html', context)

def add_images(request,id):
    context = {'property_id':id}
    return render(request, 'customer/add_images.html', context)
...
def add_images_store(request):
    ...
    return redirect('/customer/view_my_property')
...
def view_property_details(request,id):
    ...
    return render(request, 'customer/view_property_details.html', context)

def search_property(request):
    result = City.objects.all()
    result1 = Area.objects.all()
    context = {'result':result,'result1':result1}
    return render(request, 'customer/search_property.html', context)
...
def search_with_details(request):
    ...
    context = {'result':result}
    return render(request, 'customer/all_property.html', context)

def view_property(request,id):
    result = Post_property.objects.get(pk=id)
    result2 = Add_more_images.objects.filter(post_property_id=id)
    context = {'result':result,'result2':result2}
    return render(request, 'customer/view_property.html', context)
...
def request_store(request):
    ...
    return redirect('/customer/search_property')
...
def view_request(request):
    ...
    context = {'result':result}
    return render(request,'customer/view_request.html',context)

def accept_request(request,id):
    result = Buy_property.objects.get(pk=id)
    context = {'result':result}
    return render(request,'customer/accept_request.html', context)
...
def accept_request_store(request,id):
    ...
    return redirect('/customer/view_request')

def all_properties(request):
    result = Post_property.objects.all()
    context = {'result':result}
    return render(request, 'customer/all_properties.html', context)
...
def view_my_request(request):
    ...
    context = {'result':result}
    return render(request,'customer/view_my_request.html',context)
